...
import {
	Alert, Box, Button, Card, CardActionArea, CardContent, Collapse, CssBaseline, Dialog, DialogActions,
...
export default function Permits({ permits, permitCreated, setPermitCreated, workers }) {
	...
	return (
		...
		>
			...
			<Box sx={{
				py: 5, pl: 15, pr: 10, bgcolor: '#f1f3f3',
				display: 'flex', flexDirection: 'column', justifyContent: 'center', mt: 12.5
			}}>
				<Box>
					<Box sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
						...
						<Box sx={{ display: 'flex', flexDirection: 'row', height: '3rem' }}>
							<Button variant="contained"
								sx={{
									bgcolor: '#00a4a9', m: 1, fontSize: 12,
					...
					<DialogActions sx={{ mb: '0.5rem', display: 'flex', flexDirection: 'column' }}>
						...
						<Box sx={{ display: 'flex', alignSelf: 'flex-end', mt: '1rem' }}>
							<Button variant="contained" onClick={handleClose} disableElevation={true}
								sx={{
									bgcolor: 'white', color: '#00a4a9', fontWeight: 500, mx: 1,
									"&:hover": {
										bgcolor: '#ffffff',
										color: "#008488"
									}
